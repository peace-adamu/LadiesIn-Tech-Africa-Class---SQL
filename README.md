...
```
##### Result: ![sqlb1](https://github.com/user-attachments/assets/dc1a0278-9842-4c92-a579-12365bf6e3dc)
- Result
...
```
##### Result: ![sqlb2](https://github.com/user-attachments/assets/208d6574-edd1-4aaf-977c-aa05b9c2da01)
...
1. Market-Specific Profitability: Nigeria's impact on overall profitability.
2. Yearly Trends: A basis for comparison with previous and future years.
3. Strategic Focus: Whether resources should be increased in Nigeria based on profit margins.
...
ORDER BY 2 DESC;
```
##### Result: ![sqlb3](https://github.com/user-attachments/assets/73e3d6aa-5194-4dd0-90eb-67453fb62e24)
